	...
	<div class="row portfolio-item margin-bottom-20"> 
        ...
        <div class="col-md-7 col-xs-12">
			...
			<ul class="rrssb-buttons clearfix" style="margin-bottom:5px;">
				<li class="email">
					<a href="mailto:?subject=Check out this awesome product from C-View Windows&amp;body=http://www.c-view.com.au/window/{!! $product->url !!}">
						<span class="icon">
				...
				<li class="facebook">
					<a href="https://www.facebook.com/sharer/sharer.php?u=http://www.c-view.com.au/window/{!! $product->url !!}" class="popup">
						<span class="icon">
				...
				<li class="twitter">
					<a href="http://twitter.com/home?status=Check out this awesome product from C-View Windows - http://www.c-view.com.au/window/{!! $product->url !!}" class="popup">
						<span class="icon">
				...
				<li class="googleplus">
                        ...
                        <a href="https://plus.google.com/share?url=http://www.c-view.com.au/window/{!! $product->url !!}" class="popup">
                            <span class="icon">
                                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="28px" height="28px" viewBox="0 0 28 28" enable-background="new 0 0 28 28" xml:space="preserve">
                                    <g>
                                        <g>
			...
			<div class="modal fade bs-pdf-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
				<div class="modal-dialog modal-lg">
					<div class="modal-content">
						<iframe src="/uploads/{!! $product->brochure->file !!}" width="100%" height="700"></iframe>
					</div>
				</div>
			</div>
	@endif
