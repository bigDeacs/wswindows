	...
	<div class="breadcrumbs margin-bottom-20">
	    <div class="container">
	        ...
	        <ul class="pull-right breadcrumb hidden-xs">
	            <li><a href="/">Home</a></li>
	            <li><a href="/doors">{!! $product->category->name !!}</a></li>
	...
	<div class="row portfolio-item margin-bottom-20"> 
        ...
        <div class="col-md-7 col-xs-12">
			...
			<ul class="rrssb-buttons clearfix" style="margin-bottom:5px;">
				<li class="email">
					<a href="mailto:?subject=Check out this awesome product from C-View Windows&amp;body=http://www.c-view.com.au/door/{!! $product->url !!}">
						<span class="icon">
				...
				<li class="facebook">
					<a href="https://www.facebook.com/sharer/sharer.php?u=http://www.c-view.com.au/door/{!! $product->url !!}" class="popup">
						<span class="icon">
				...
				<li class="twitter">
					<a href="http://twitter.com/home?status=Check out this awesome product from C-View Windows - http://www.c-view.com.au/door/{!! $product->url !!}" class="popup">
						<span class="icon">
				...
				<li class="googleplus">
                        ...
                        <a href="https://plus.google.com/share?url=http://www.c-view.com.au/door/{!! $product->url !!}" class="popup">
                            <span class="icon">
                                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="28px" height="28px" viewBox="0 0 28 28" enable-background="new 0 0 28 28" xml:space="preserve">
                                    <g>
                                        <g>
			...
			<!-- Comment Box -->
			<div class="fb-comments hidden-xs" data-href="http://c-view.com.au/door/{!! $product->url !!}" data-numposts="3" data-colorscheme="light" data-width="100%"></div>
        </div>
